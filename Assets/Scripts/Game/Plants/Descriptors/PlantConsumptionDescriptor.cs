...
namespace Game.Plants.Descriptors
{
    ...
    public class PlantConsumptionDescriptor
    {
        ...
        [field: SerializeField, Range(0f, 2f), Tooltip("Multiplier for all elements. If soil contains enough, plant will receive grow buff. If not - nothing happens. If soil doesn't have enough of any element, plant will use humus. If humus is also doesn't exist, them plant won't grow at all.")]
