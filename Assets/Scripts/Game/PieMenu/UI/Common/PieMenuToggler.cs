...
namespace Game.PieMenu.UI.Common
{
    public class PieMenuToggler : MonoBehaviour
    {
        ...
        private readonly Dictionary<PieMenuController, PieMenuState> _pieMenuStates = new();
        ...
        private void RegisterNewMenu(PieMenuController pieMenu)
        {
        ...
        private void ShowPieMenu(PieMenuState state)
        {
            ...
            StartCoroutine(WaitForAudioAndAnimationToFinishPlaying(state, true));
        }
        ...
        private void HidePieMenu(PieMenuState state)
        {
            ...
            StartCoroutine(WaitForAudioAndAnimationToFinishPlaying(state, false));
        }

        private IEnumerator WaitForAudioAndAnimationToFinishPlaying(PieMenuState state, bool isActive)
        {
            float timeToWait = CalculateTimeToWait(state.PieMenuController);
            ...
            state.PieMenuController.PieMenuModel.SetActiveState(isActive);
        }
        ...
        private void CloseOnReturnPressed()
        {
            ...
            if (returnPressed) {
                SetActive(_currentMenu.PieMenuController, false);
            }
        }
        ...
        private void DisableInfoPanel(PieMenuState state)
        {
            if (state.PieMenuModel.InfoPanelEnabled) {
                _generalSettings.SetActive(state.PieMenuController, false);
            }
        }
        ...
        private void EnableInfoPanel(PieMenuState state)
        {
            ...
            PieMenuController pieMenu = state.PieMenuController;
    ...
    {
        public PieMenuController PieMenuController { get; private set; } = null!;
        ...
        public void SetComponents(PieMenuController pieMenu)
        {
